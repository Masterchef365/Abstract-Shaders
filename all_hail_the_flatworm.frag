...
vec3 pixel(vec2 coords) {
    ...
    st.x += -sign(st.x) * -0.076;
    st.x += cos(st.y * 8.288 + u_time / 3.) * .1;
    if (length(st * vec2(0.980,-0.500)) < 0.196) color = vec3(0);

    return color * vec3(1.000,0.194,0.060);
}
